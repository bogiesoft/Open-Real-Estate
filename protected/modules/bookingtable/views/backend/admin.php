...
<?php $this->widget('CustomGridView', array(
	...
	'filter'=>$model,
	'ajaxUpdate' => false,
	'afterAjaxUpdate' => 'function(){$("a[rel=\'tooltip\']").tooltip(); $("div.tooltip-arrow").remove(); $("div.tooltip-inner").remove(); jQuery("#Bookingtable_date_start").datepicker(jQuery.extend(jQuery.datepicker.regional["'.Yii::app()->controller->datePickerLang.'"],{"showAnim":"fold","dateFormat":"yy-mm-dd","changeMonth":"true","showButtonPanel":"true","changeYear":"true"})); attachStickyTableHeader();}',
	'columns' => array(
		array(
			'name' => 'id',
			'htmlOptions' => array(
